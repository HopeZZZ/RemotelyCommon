package com.zhongke.common.widget.anim;
...
public class ZKFrameAnimation {
     ...
     */
    public ZKFrameAnimation(ImageView iv, int[] frameRes, int duration, boolean isRepeat) {
        this.mImageView = iv;
     ...
     * @param isPlay   是否立刻播放
     */
    public ZKFrameAnimation(ImageView iv, int[] frameRes, int duration, boolean isRepeat, boolean isPlay) {
        this.mImageView = iv;
        this.mFrameRess = frameRes;
        this.mDuration = duration;
        this.mLastFrame = frameRes.length - 1;
     ...
     * @param isRepeat  是否循环播放
     */
    public ZKFrameAnimation(ImageView iv, int[] frameRess, int[] durations, boolean isRepeat) {
        this.mImageView = iv;
     ...
     */
    public ZKFrameAnimation(ImageView iv, int[] frameRess, int duration, int delay) {
        this.mImageView = iv;
        this.mFrameRess = frameRess;
        this.mDuration = duration;
        this.mDelay = delay;
     ...
     * @param delay     循环播放的时间间隔
     */
    public ZKFrameAnimation(ImageView iv, int[] frameRess, int[] durations, int delay) {
        this.mImageView = iv;
        this.mFrameRess = frameRess;
        this.mDurations = durations;
        this.mDelay = delay;
