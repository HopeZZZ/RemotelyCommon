...
public class ZKFrameAnimImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public ZKFrameAnimImageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZKFrameAnimImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
