 ...
 * 圆形进度条，可以设置最大进度，当前进度
 */
public class ZKSimpleRoundProgress extends View {
    ...
    public ZKSimpleRoundProgress(Context context) {
        this(context, null);
    }

    public ZKSimpleRoundProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZKSimpleRoundProgress(Context context, AttributeSet attrs, int defStyle) {
        ...
        // 获取自定义属性和默认值
        roundColor = mTypedArray.getColor(R.styleable.SimpleRoundProgress_srp_roundColor, Color.parseColor("#999999"));
        roundWidth = mTypedArray.getDimension(R.styleable.SimpleRoundProgress_srp_roundWidth, 3);
        progressColor = mTypedArray.getColor(R.styleable.SimpleRoundProgress_srp_progressColor, Color.WHITE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.d("onDraw", "========onDraw: " + sweepAngle);
        // 根据进度画圆弧
        switch (style) {
            case STROKE:
                // 空心
