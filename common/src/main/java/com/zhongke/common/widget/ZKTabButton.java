...
public class ZKTabButton extends LinearLayout {
    ...
    public ZKTabButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZKTabButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mDrawableIndex != index) {
                    ...
                    if (index == (mDrawaleArrayLength / 3) && mText != null && needAnim){
    ...
    public void reSetDrawables(Context context,int iconArrayId){
        TypedArray arr = getResources().obtainTypedArray(iconArrayId);
        int len = arr.length();
        int[] iconResArray = new int[len];
        for (int i = 0; i < len; i++) {
        ...
        mDrawaleArrayLength = mDrawables.length;
    }
