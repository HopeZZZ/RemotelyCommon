package com.zhongke.common.imageloader.glidetransform;
 ...
 * @author: 陈元旺
 * @date: 2021/8/30
 * @description 参考 https://github.com/wasabeef/glide-transformations的RoundedCornersTransformation实现
 */
public class ZKRoundedCornersTransformation extends ZKBitmapTransformation {
...
//    }
    ...
    private final ZKImageCornerType cornerType;

    public ZKRoundedCornersTransformation(int radius, int margin) {
        this(radius, margin, ZKImageCornerType.ALL);
    }

    public ZKRoundedCornersTransformation(int radius, int margin, ZKImageCornerType cornerType) {
        this.radius = radius;
    ...
    public boolean equals(Object o) {
        return o instanceof ZKRoundedCornersTransformation &&
                ((ZKRoundedCornersTransformation) o).radius == radius &&
                ((ZKRoundedCornersTransformation) o).diameter == diameter &&
                ((ZKRoundedCornersTransformation) o).margin == margin &&
                ((ZKRoundedCornersTransformation) o).cornerType == cornerType;
    }
