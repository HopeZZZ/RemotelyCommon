 ...
 * @author: 陈元旺
 * @date: 2021/8/30
 * @description 参考 https://github.com/wasabeef/glide-transformations的BitmapTransformation实现
 */
public abstract class ZKBitmapTransformation implements Transformation<Bitmap> {
