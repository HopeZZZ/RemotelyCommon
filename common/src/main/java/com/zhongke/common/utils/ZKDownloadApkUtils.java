        ...
        try {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    request.setTitle("爱玩宝");//设置下载中通知栏提示的标题
    ...
    class CompleteReceiver extends BroadcastReceiver {
        ...
        private void downComplete(Context context,String filePath) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri contentUri = FileProvider.getUriForFile(context, "com.zhongke.inisland.fileprovider", _file);
                ZKLog.d("uriHost=" + contentUri.getHost());
